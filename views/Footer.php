			...
			<div class="footer_content">
				<div class="row">
					...
					<div class="col-lg-4 footer_col">
						...
						<p class="footer_about_text">Committed to educating and nurturing all students so they may grow towards responsible global citizenship</p>
					...
					<div class="col-lg-4 footer_col">
						...
						<div class="footer_column_content">
							<ul>
								<li class="footer_list_item"><a href="<?= base_url('Folk_c/index')?>">Home</a></li>
								<li class="footer_list_item"><a href="<?= base_url('Folk_c/about')?>">About Us</a></li>
						...
						<div class="footer_column_content">
							<ul>
								<li class="footer_contact_item">
									...
									Dagara House, Khushaldas Dagara Marg, Station Road, S.V. Road, 400064 Mumbai, India
								</li>
								<li class="footer_contact_item">
									<div class="footer_contact_icon">
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made by <a href="https://webtactic.in" target="_blank">Webtactic</a>
