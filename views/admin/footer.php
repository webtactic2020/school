  ...
  <!-- Chat Box End-->
    ...
    <script src="<?= base_url('assets/admin/js/flot/flot-active.js');?>"></script>
    <!-- map JS
		============================================ -->
    <script src="<?= base_url('assets/admin/js/map/raphael.min.js');?>"></script>
    <script src="<?= base_url('assets/admin/js/map/jquery.mapael.js');?>"></script>
    <script src="<?= base_url('assets/admin/js/map/france_departments.js');?>"></script>
    <script src="<?= base_url('assets/admin/js/map/world_countries.js');?>"></script>
    <script src="<?= base_url('assets/admin/js/map/usa_states.js');?>"></script>
    <script src="<?= base_url('assets/admin/js/map/map-active.js');?>"></script>
    <!-- data table JS
		============================================ -->
